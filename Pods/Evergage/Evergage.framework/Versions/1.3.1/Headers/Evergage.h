...
#error "Evergage Framework requires iOS Deployment Target >= 7.0"
#endif
...
/**
 Typically unused, for tracking behavior outside of a UIViewController.
 
 A UIViewController should instead use the `<EVGScreen>` returned by
