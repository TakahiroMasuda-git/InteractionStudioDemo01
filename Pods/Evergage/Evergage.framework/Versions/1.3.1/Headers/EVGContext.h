...
/**
 ...
 This method should be preferred over `evergage.globalContext trackAction:`, since actions
 sent from this context (including Item APIs) can potentially receive a campaign
 in response, delivered to a handler via `<setCampaignHandler:forTarget:>`.
